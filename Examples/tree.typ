...
type Tree2[A,B] = !K1!K2 F_Tree[A,B,K1,K2];
...
let leaf'' =  /\A/\B/\P (fun f:G2[A,B,P] => (fun a:A r1 r2 => f (fun x => x):(/\K K -> P) (fun x => x):(/\K K -> P) (leaf' a)):U[A,P]);
let node'' =  /\A/\B/\P (fun f:G2[A,B,P] =>
   (/\K1/\K2 (fun sl:(K1 -> U[A,P] -> K1 -> K2 -> P) 
                          b:B 
                          sr:(K2 -> U[A,P] -> K1 -> K2 -> P) 
                          r1:K1 r2:K2
  => f (fun r1' => sl r1' (leaf'' f) r1' r2) (fun r2' => sr r2' (leaf'' f) r1 r2') (node' r1 b r2))) : T[A,B,P]);
...
let leaf'' =  /\A/\B/\P (fun f:G[A,B,P] => (fun a:A r => f (fun x => x):(/\K K -> P) (fun x => x):(/\K K -> P) (leaf' a)):U[A,P]);
let node'' =  /\A/\B/\P (fun f:G[A,B,P] => (fun sl b sr r => f (sl r (leaf'' f)) (sr r (leaf'' f)) (node' r b r)) : T[A,B,P]);
